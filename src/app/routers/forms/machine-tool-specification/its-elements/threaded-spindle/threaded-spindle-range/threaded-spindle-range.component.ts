...
export class ThreadedSpindleRangeComponent implements OnInit {
  ...
  get model() {
    return this.machineToolSpecificationService
      .machine_tool_specification.its_elements[this.activeArrayIndex].capabilities.threaded_spindle[this.spindleIndex].range;
  }

  set model(model) {
    this.machineToolSpecificationService
      .machine_tool_specification.its_elements[this.activeArrayIndex].capabilities.threaded_spindle[this.spindleIndex].range = model;
  }
